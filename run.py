...
def seed_titles():
    ...
    titles = [
        ...
        # ── Вечные, раунд 2 ────────────────────────────────────────────
        ("peak_elo", "Пик формы", "Наивысший текущий ELO клуба.",
         "bi-graph-up-arrow", Rarity.LEGENDARY, TitleType.ETERNAL),
        ("financial_baron", "Финансовый барон", "Больше всего заработано монет за карьеру.",
         "bi-cash-stack", Rarity.EPIC, TitleType.ETERNAL),
        ("cup_king", "Кубковый король", "Больше всего побед в турнирах за всю историю.",
         "bi-trophy-fill", Rarity.LEGENDARY, TitleType.ETERNAL),
        ("season_crowned", "Коронованный сезонами", "Больше всего побед в сезонах за всю историю.",
         "bi-award-fill", Rarity.LEGENDARY, TitleType.ETERNAL),
        ("club_sniper", "Снайпер клуба", "Самая высокая точность «Лучшего хода» за карьеру.",
         "bi-crosshair", Rarity.EPIC, TitleType.ETERNAL),
        ("move_master", "Мастер хода", "Больше всего раз признан лучшим ходом партии.",
         "bi-stars", Rarity.EPIC, TitleType.ETERNAL),
        ("fantasy_oracle", "Fantasy-оракул", "Больше всего fantasy-очков за всю историю.",
         "bi-joystick", Rarity.EPIC, TitleType.ETERNAL),
        ("stability", "Стабильность", "Лучший общий винрейт за карьеру.",
         "bi-graph-up", Rarity.RARE, TitleType.ETERNAL),
        ("tournament_terror", "Гроза турниров", "Лучший процент топ-3 финишей в турнирах.",
         "bi-award", Rarity.EPIC, TitleType.ETERNAL),
        ("achievement_keeper", "Хранитель наград", "Больше всего разблокированных достижений.",
         "bi-trophy", Rarity.RARE, TitleType.ETERNAL),
        ...
        ("season_breakthrough", "Прорыв сезона", "Наибольший рост места в рейтинге относительно прошлого сезона.",
         "bi-rocket-takeoff-fill", Rarity.RARE, TitleType.SEASONAL),
        ("season_mafia_terror", "Гроза города сезона", "Лучший винрейт за мафию в этом сезоне.",
         "bi-mask", Rarity.EPIC, TitleType.SEASONAL),
        ("season_city_shield", "Щит города сезона", "Лучший винрейт за город в этом сезоне.",
         "bi-shield-check", Rarity.EPIC, TitleType.SEASONAL),
        ("season_fantasy_champion", "Fantasy-чемпион сезона", "Больше всего fantasy-очков за турниры сезона.",
         "bi-joystick", Rarity.RARE, TitleType.SEASONAL),
        ("year_player", "Игрок года", "Победитель по итогам всего календарного года.",
         "bi-calendar-heart-fill", Rarity.LEGENDARY, TitleType.SEASONAL),
        ("season_sharpshooter", "Меткий стрелок сезона", "Больше всего идеальных «Лучших ходов» за сезон.",
         "bi-crosshair", Rarity.RARE, TitleType.SEASONAL),
        ("season_marathoner", "Марафонец сезона", "Больше всего сыгранных игр за сезон.",
         "bi-lightning-charge-fill", Rarity.RARE, TitleType.SEASONAL),
    ]
