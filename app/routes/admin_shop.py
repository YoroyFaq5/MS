...
THEMES: list[tuple[str, str]] = [
    ...
    ("oceanic", "🌊 Океан"),
    ("tidal", "🌊 Прилив"),
    ("royalgold", "👑 Королевское золото"),
    ("prismatic", "🔮 Призма"),
    ("crystal", "💠 Кристалл"),
    ("emerald", "💚 Изумруд"),
    ("liquidmetal", "🪞 Жидкий металл"),
    ("runic", "🗿 Руны"),
    ...
    ("cyberpunk", "🤖 Киберпанк"),
    ("quantum", "⚛️ Квант"),
    ("voidemperor", "👑 Император пустоты"),
    ("stardust", "✨ Звёздная пыль"),
    ("wildfire", "🔥 Дикий огонь"),
    ("abyss", "🌑 Бездна"),
    ("radiant", "🕊️ Сияние"),
    ("infernal", "😈 Адское пламя"),
    # ── Mythic ULTRA (переработаны на 3+ независимых слоя каждый) ────────
    ("void", "⚫ Пустота ULTRA"),
    ("aurora", "💫 Аврора ULTRA"),
    ("event_horizon", "🕳️ Горизонт событий ULTRA"),
    ("thunder_god", "🌩️ Громовержец ULTRA"),
    ("phoenix", "🐦‍🔥 Феникс ULTRA"),
    ("dragon", "🐉 Душа дракона ULTRA"),
    ("cosmos", "☄️ Космос ULTRA"),
